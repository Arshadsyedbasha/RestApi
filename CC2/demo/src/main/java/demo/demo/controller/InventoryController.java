...
public class InventoryController {
    ...
    public List<Inventory> getMethodName(@PathVariable String param) {
        return p.sort(param);
    }
    @GetMapping("/page/{a}/{b}")
    public List<Inventory> getMethodName(@PathVariable int a,@PathVariable int b) {
        return p.page(a, b);
    }

    @GetMapping("/path/joinquery")
    public List<Inventory> join() {
        return p.getall();
    }
